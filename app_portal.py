...
# تخصيص التصميم ليتناسب بسلاسة فائقة مع متصفحات الهواتف المحمولة وتوجيه الواجهة (RTL) وتنسيق الطباعة الكاملة
st.markdown("""
    <style>
    body, html, [class*="css"] {
        direction: rtl;
    ...
    /* تنسيق الجداول المباشرة للطباعة الشاملة */
    table {
        width: 100% !important;
    ...
    /* إعدادات مخصصة لطباعة أو تصدير PDF بكامل الصفوف والاتجاه الأفقي */
    @media print {
        @page {
            size: landscape;
            margin: 10mm;
    ...
    if student_id_input:
        ...
        with tab2:
            ...
            if target_col_idx is not None:
                ...
                # دالة تلوين خلايا عمود "حالة المقرر" وتنسيق الـ HTML للطباعة
                ...
                # عرض جدول السجل بنظام HTML المباشر ليظهر كاملاً عند الطباعة
